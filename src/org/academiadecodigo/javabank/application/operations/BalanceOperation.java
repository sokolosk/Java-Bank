...
import org.academiadecodigo.javabank.application.controls.MenuControl;
...
public class BalanceOperation extends AbstractBankOperation {
     ...
     *
     * @see AbstractBankOperation#AbstractBankOperation(MenuControl)
     */
    public BalanceOperation(LoginControl loginControl) {
        super(loginControl);
    }
