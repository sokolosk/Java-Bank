...
public abstract class AbstractAccountTransactionOperation extends AbstractBankOperation {
     ...
     */
    public AbstractAccountTransactionOperation(LoginControl loginControl) {
        super(loginControl);
        prompt = loginControl.getPrompt();
        accountManager = loginControl.getBank().getAccountManager();
    }
